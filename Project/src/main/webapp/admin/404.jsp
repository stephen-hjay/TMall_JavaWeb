...
<%--<p><span id="404">404: Requested Page Not Found or Not Authorized!</span>--%>
<%--<p>Return to main page, after<span id="mySecond">5</span>seconds.<a href="javascript:goBack();">Jump Now</a></p>--%>
...
<%--    var num=4;--%>
<%--    function count(){--%>
<%--        document.getElementById("mySecond").innerHTML = num;--%>
<%--        num--;--%>
<%--        setTimeout("count()",1000);--%>
<%--        if(num==1){--%>
<%--            window.location.assign("localhost:3030/Tmall/admin");--%>
<%--        }--%>
<%--    }--%>
<%--    setTimeout("count()",1000);--%>

<%--    //通过window.history对象来控制网页的跳转。--%>
<%--    function goBack(){--%>
<%--        window.location.assign("localhost:3030/Tmall/admin");--%>
<%--    }--%>
<%--</script>--%>
...
<p class="bg-warning" id="errorMsg">${error.message}</p>
...
<center><div id="backtomain">
    <a href="/Tmall/admin"><button  type="button" class="btn btn-primary ">Back To Main</button></a>
</div></center>
