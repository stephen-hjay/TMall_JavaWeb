...
<title>Prodcut Image Management</title>
		...
		<tr>
			<td class="addPictureTableTD">
			  <div>
				<div class="panel panel-warning addPictureDiv">
					<div class="panel-heading">New Product<b class="text-primary"> Single </b>Image</div>
			...
			<td class="addPictureTableTD">
			  <div>
				...
				<div class="panel panel-warning addPictureDiv">
					<div class="panel-heading">New Product<b class="text-primary"> Detail </b>Image</div>
					  <div class="panel-body">
